...
if __name__ == "__main__":
    ...
    model_train_obj.testing_split(test_epoch, test_class ='unseen', dataset = data, threshold = threshold)
    model_train_obj.testing_split(test_epoch, test_class ='seen', dataset = data, threshold = threshold)
