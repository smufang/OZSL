...
class AwA2(object):
    ...
    def prepare_data(self):
        ...
        attr_data = torch.load('/home/sethupathy/openworl_zsl/A-Boundary-Based-Out-of-Distribution-Classifier-for-Generalized-Zero-Shot-Learning-master/synthetic_data_svae/attr.pth')
        ...
        assert(len(np.unique(self.train_labels)) == 5)
