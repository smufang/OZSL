...
class Model_train(object):
    ...
    def testing_split(self, epoch, test_class = 'seen', dataset = None, threshold = 0.99):
        ...
        # torch.save(data_dict, '/home/sethupathy/openworl_zsl/zsl-openworld/test_classifier_cvae/{}_data_{}.pt'.format(self.dataset_name, test_class))
        torch.save(data_dict, '/home/sethupathy/openworl_zsl/A-Boundary-Based-Out-of-Distribution-Classifier-for-Generalized-Zero-Shot-Learning-master/data_split_no_svae_seed/{}_data_{}_seed{}.pt'.format(self.dataset_name, test_class, self.seed))
    ...
    def testing_split_ood_synthetic(self, epoch, seen_classes, known_unseen_classes, dataset = None, threshold = 0.99):
        scaler = preprocessing.MinMaxScaler()
        #####################################################################
        DATASET = 'AWA2'
    ...
    def testing_seen(self, epoch, seen_classes, known_unseen_classes, dataset = None, threshold = 0.99):
        scaler = preprocessing.MinMaxScaler()
        #####################################################################
        DATASET = 'AWA2'
        print(f'<=============== Loading data for {DATASET} ===============>')
